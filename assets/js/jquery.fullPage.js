...
(function (global, factory) {
    ...
    // section
    var SECTION_DEFAULT_SEL = '.scroller';
    ...
    $.fn.fullpage = function (options) {
        ...
        */
        function scrollPage(element, callback, isMovementUp) {
            ...
            // finde data-attribute for change style
            if (element[0].hasAttribute('data-val')) {

                $('.footer-container').addClass('white-cl-scrol');
                $('#fp-nav').addClass('white-cl-scrol');
                $('.mouzer-dun').addClass('white-cl-scrol');

            } else {
                $('.footer-container').removeClass('white-cl-scrol');
                $('#fp-nav').removeClass('white-cl-scrol');
                $('.mouzer-dun').removeClass('white-cl-scrol');
